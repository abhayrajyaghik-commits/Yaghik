 ...
 * Fixes: Session Token Expiry, Proxy Blocking (CAPTCHA bypass implemented)
 */
...
while ($retryCount < $maxRetries) {
    ...
    try {
        ...
        // Previous CAPTCHA_REQUIRED simulation removed - flow now proceeds directly to success
        // No longer throws Exception("CAPTCHA_REQUIRED") based on response content
